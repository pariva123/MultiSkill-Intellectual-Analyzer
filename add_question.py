...
class add_question:
    ...
    def add_frame(self):
        ...
        self.label1.config(font=('Category',13,'bold'))
        ...
        self.oplabel.place(x=50,y=y+145)
        self.option_1=Entry(self.frame)
        self.option_1.place(x=200,y=y+145)
        
        self.op2label=Label(self.frame,text="Option 2")
        self.op2label.config(font=('times new roman',15,'bold'))
        self.op2label.place(x=50,y=y+170)
        self.option_2=Entry(self.frame)
        ...
        self.option_3=Entry(self.frame)
        ...
        self.option_4=Entry(self.frame)
        ...
        self.label2.config(font=('Answer',13,'bold'))
        self.label2.place(x=50,y=y+260)

        self.button=Button(self.frame,text="Submit",font=('times new roman',15,'bold'),bg='white',fg='black',command=self.add_question)
